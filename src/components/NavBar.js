...
export default function NavBar() {
    ...
    return (    <>
      ...
      <Menu.Item name='mychal wood' as={Link} className="title" onClick={closeNav} href='/' />
      <div className={isToggled ? "bars active" : "bars"} onClick={toggleNav}>
          <span className="bar"></span>
          <span className="bar"></span>
          <span className="bar"></span>
        </div>
      <Menu.Menu className={isToggled ? "items active" : "items"}>
        <Menu.Item name='about' as={Link} href='/about' onClick={toggleNav}/>
        <Menu.Item name='work' as={Link} href='/work' onClick={toggleNav}/>
        <Menu.Item name='contact' as={Link} href='/contact' onClick={toggleNav}/>
      </Menu.Menu>
      </Menu>
      </>
    )
