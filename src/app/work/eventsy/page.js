      ...
      <Grid columns="1" verticalAlign="center">
        <Grid.Row columns={1}>
          <Grid.Column mobile={12} tablet={10} computer={8} textAlign="center">
            ...
            <p>
              This Eventsy was a website I made in a web development bootcamp I
              took in the fall of 2023, and was the start of my more advanced
              website development techniques and software. This was made by
              replicating the website, and it's spacing using an Adobe XD file
              template.
            </p>
          </Grid.Column>
        </Grid.Row>
